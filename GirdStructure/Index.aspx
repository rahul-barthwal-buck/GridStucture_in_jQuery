        ...
        function GetPageSize(sel) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var temp = "<table style='width:800px;'  class='table table-bordered table-striped table-sm prdtable' border='1'><tr  id='PrdDetails'><th colspan='3'>Product Details</th><th id='UnitStock'  rowspan='2' >Units In Stock</th><th colspan='3' rowspan='2' id ='Operaions'>Operations</th></tr><tr><th>Product Name&nbsp;&nbsp;<a href='#' id='SortByAscProductName' onclick='SortByAscProductName();'>&uarr;</a>&nbsp;<a href='#' id='SortByDescProductName' onclick='SortByDescProductName();'>&darr;</a></th><th>Quantity per Unit&nbsp;&nbsp;<a href='#' id='SortByAscQuantityperUnit' onclick='SortByAscQuantityperUnit();'>&uarr;</a>&nbsp;<a href='#' id='SortByDescQuantityperUnit' onclick='SortByDescQuantityperUnit();'>&darr;</a></th><th>Unit Price&nbsp;&nbsp;<a href='#' id='SortByAscUnitPrice' onclick='SortByAscUnitPrice();'>&uarr;</a>&nbsp;<a href='#' id='SortByDescUnitPrice' onclick='SortByDescUnitPrice();'>&darr;</a></th></tr>";
